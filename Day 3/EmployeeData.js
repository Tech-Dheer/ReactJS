...
function EmployeeData() {
    ...
    function addDeptButton_click() {
        ...
        let tempArray = [...deptsArray, deptObj];
        setDeptsArray(tempArray);
        clearFields();
    }
    ...
    let resultArray = deptsArray.map((item, index) => (
        <tr key={index}>
            ...
            <td className="action-icons">
                <img src='./images/edit.png' alt="Edit" onClick={() => selectDept_click(item.deptno)} />
                <img src='./images/delete.png' alt="Delete" onClick={() => deleteDept_click(item.deptno)} />
            </td>
        </tr>
    ));
